<x-layout>
    ...
    @section('page-title')
        <h4 class="page-title pull-left">Change details - {{ $role->name }}</h4>
    @endsection
                        ...
                        <div class="form-wrapper">
                            <form action="{{ route('roles.update',$role->id) }}" method="POST">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input class="form-control @error('name') invalid-input @enderror" type="text" name="name"  id="name" value="{{ old('name',$role->name) }}">
                                    @error('name')
