<x-layout>
    ...
    @section('page-title')
        <h4 class="page-title pull-left">Change details - {{ $user->name }}</h4>
    @endsection
                        ...
                        <div class="form-wrapper">
                            <form action="{{ route('users.update',$user->id) }}" method="POST">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input class="form-control @error('name') invalid-input @enderror" type="text" name="name"  id="name" value="{{ old('name',$user->name) }}">
                                    @error('name')
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input class="form-control @error('email') invalid-input @enderror" type="email" name="email" id="email" value="{{ old('email', $user->email) }}">
                                    @error('email')
                                        <div class="text-danger mt-1">{{ $message }}</div>
                                    @enderror
                                </div>
